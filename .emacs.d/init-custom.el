...
(custom-set-variables
 ...
 '(openwith-associations (quote (("\\.pdf\\'" "evince" (file)) ("\\.mp3\\'" "mplayer" (file)) ("\\.\\(doc\\|docx\\|xls\\|xlsx\\)\\'" "soffice" (file)) ("\\.mkv\\'" "vlc" (file)) ("\\.avi\\'" "vlc" (file)) ("\\.mp4\\'" "vlc" (file)) ("\\.ppt\\'" "soffice" (file)) ("\\.pptx\\'" "soffice" (file)) ("\\.wmv\\'" "vlc" (file)) ("\\.flv\\'" "vlc" (file)) ("\\.hwp\\'" "hanword" (file)))))
 '(org-agenda-sticky t)
